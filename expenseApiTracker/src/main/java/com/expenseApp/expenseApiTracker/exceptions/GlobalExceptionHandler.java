package com.expenseApp.expenseApiTracker.exceptions;
...
import com.expenseApp.expenseApiTracker.entity.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorObject> handleMethodArgumentMistmatchException(MethodArgumentTypeMismatchException ex, WebRequest request){
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		body.put("satusCode", HttpStatus.BAD_REQUEST.value());
